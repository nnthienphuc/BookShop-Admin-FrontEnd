...
export default function OrderPage() {
  ...
  const handleUpdateOrder = async () => {
    try {
      const payload = {
        status: form.status, note: form.note || "", isDeleted: form.isDeleted || false
      };
    ...
    <div className="container mt-4">
      ...
      <div className="d-flex gap-2 mb-3">
        ...
        <input placeholder="Tìm kiếm..." value={search}
          className="form-control w-25" onChange={e => setSearch(e.target.value)}
        />
      </div>
      ...
      <table className="table table-bordered table-hover">
        <thead><tr>
          <th>#</th>
          {["staffName","customerName","customerPhone","createdTime","status","shippingFee","totalAmount","isDeleted"]
            .map((key,i) => (
              <th key={i} onClick={() => handleSort(key)} style={{cursor:"pointer"}}>
                {["Nhân viên","Khách hàng","SĐT Khách","Ngày","Trạng thái","Phí ship","Tổng tiền","Đã xoá"][i]}
                {renderSortIcon(key)}
              </th>
            ))}
          <th>Thao tác</th>
              ...
              <td>
                <div className="d-flex flex-column">
                  <button className="btn btn-info btn-sm mb-1"
                    onClick={() => { setForm(o); setModalVisible(true); }}>Sửa</button>
                  <button className="btn btn-danger btn-sm"
                    onClick={() => setDeleteId(o.id)}>Xóa</button>
                  <button className="btn btn-secondary btn-sm mb-1"
                    onClick={() => fetchOrderItems(o.id)}>Chi tiết</button>
                </div>
              </td>
            </tr>
          ))}
        ...
        <div className="modal show fade d-block" tabIndex="-1">
          <div className="modal-dialog modal-lg"><div className="modal-content">
            <div className="modal-header">
              ...
              <button type="button" className="btn-close" onClick={() => setDetailPopupOrderId(null)}></button>
            </div>
            <div className="modal-body">
              <table className="table">
                <thead><tr><th>#</th><th>Sách</th><th>Đơn giá</th><th>Số lượng</th><th>Thành tiền</th></tr></thead>
                <tbody>
            ...
            <div className="modal-footer">
              <button className="btn btn-secondary" onClick={() => setDetailPopupOrderId(null)}>Đóng</button>
            </div>
          </div></div>
        </div>
      )}
          ...
          <div className="modal-dialog modal-lg"><div className="modal-content">
            ...
            <div className="modal-body">
              ...
              <div className="row g-3">
                ...
                <div className="col-md-6">
                  ...
                  <div className="input-group">
                    ...
                    {addForm.promotionId && (
                      <button className="btn btn-outline-danger" onClick={clearPromotion}>X</button>
                    )}
                  </div>
                </div>
                <div className="col-md-6">
              ...
              <div className="mt-3">
                ...
                <button className="btn btn-secondary mt-2" onClick={() => setAddForm({
                  ...addForm,
                  items: [...addForm.items,{ bookId:"", bookTitle:"", unitPrice:0, quantity:1 }]
      ...
      {deleteId && (
        <div className="modal show d-block" tabIndex="-1">
          <div className="modal-dialog"><div className="modal-content">
            ...
            <div className="modal-body"><p>Bạn có chắc muốn xóa đơn hàng này?</p></div>
            <div className="modal-footer">
